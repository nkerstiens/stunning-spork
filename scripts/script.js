$(function() {
    ...
    $('#btnName').click(function() {
        ...
        nameLowerCase = lowerCase(userName);
        nameMsg = "Your Name in lowercase is: ";
        $('#nameOutput').append(nameMsg + nameLowerCase + "<br/>");

        nameUpperCase = upperCase(userName);
        nameMsg = "Your Name in uppercase is: ";
        $('#nameOutput').append(nameMsg + nameUpperCase + "<br/>");

        nameFlipped = flippedName(userName);
        nameMsg = "Your Name in flipped upside down is: ";
        $('#nameOutput').append(nameMsg + nameFlipped + "<br/>");
    ...
    function lowerCase(stringVal){
        var myString = stringVal;
        myString = myString.toLowerCase();
        return myString;
    }

    function upperCase(stringVal){
        var myString = stringVal;
        myString = myString.toUpperCase();
        return myString;
    }

    function flippedName(stringVal) {	
